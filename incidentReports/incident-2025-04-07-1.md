...
```md
A bug in the pizza factory causing pizza purchasing failures. Reporting a purchasing error and fix code were required to fix the issue.
```

## Resolution

```md
The problem was resolved by submitting a fix code found in the response body of the failed purchase requests. This URL and query string were used to fix the issue, https://cs329.cs.byu.edu/api/report?apiKey=1962f5c3502342c983de7d0fef11fe73&fixCode=c6130af5044d4cdca43f3649f805fcbc\
```
